...
public class TranslateActivity extends AppCompatActivity {
    ...
    String result = "" ;
    private static final String API_KEY = "AIzaSyD5kvqZF2d1z4FIcgqUDqAKnUborEHUsQc" ;
    ...
    public void translate(){
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                EditText txtdisp=findViewById(R.id.text_extracted_display);
                String trans_string=txtdisp.getText().toString();
                final Translation translation =
                        translate.translate(trans_string,
                ...
                textViewHandler.post(new Runnable() {
                    ...
                    public void run() {
                            ...
                            //startActivity(i);
                        TextView trans_txt=findViewById(R.id.tr_txt);
                        trans_txt.setText(result);
...
//        langList.add(new languages("Tamil","ta","ta-IN"));
        ...
        Button b1=(Button)findViewById(R.id.godec);
        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getApplicationContext(),LabelDetect.class);
                startActivity(i);
            }
        });
    }
